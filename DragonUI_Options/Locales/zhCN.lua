...
L["Ignore Keeper's Aura from Target"] = "忽略目标的守护者光环"
L["Hide all buffs on the target whose name starts with 'Keeper's'."] = "隐藏目标名称以\"Keeper's\"开头的所有增益效果。"
...
L["Reverse Stack Order"] = "反向堆叠"
L["Stack sorted items from the end of each bag so empty slots stay at the top."] = "从每个背包的末尾堆叠已排序的物品，使空位保持在顶部。"
...
L["Hide Secondary Bar Background"] = "隐藏次要动作条背景"
L["Hide the background of secondary bar buttons (stance, pet, totem, etc.)."] = "隐藏次要动作条按钮的背景（姿态、宠物、图腾等）。"
L["Hide Main Bar Button Background"] = "隐藏主动作条按钮背景"
L["Hide the background of main action bar buttons."] = "隐藏主动作条按钮的背景。"
...
L["Hide Castbar Desc"] = "完全隐藏此施法条：包括 DragonUI 施法条和暴雪默认施法条。"
L["Show Icon"] = "显示图标"
...
L["Use a square minimap with a square border instead of the round DragonUI border."] = "使用方形小地图和方形边框，而不是圆形的DragonUI边框。"
...
-- Player Stats
L["Player Stats"] = "玩家属性"
L["Add item level, PvE/PvP power and prestige for player units."] = "为玩家单位显示物品等级、PvE/PvP 强度与威望。"
...
L["No position presets saved yet. Save one in Edit Mode (/dragonui edit) first."] = "尚未保存位置预设。请先在编辑模式 (/dragonui edit) 中保存一个。"
L["Position presets not available."] = "位置预设不可用。"
...
L["Not a valid DragonUI profile string."] = "不是有效的 DragonUI 配置文件字符串。"
...
L["Show Debuffs"] = "显示减益"
L["Show debuff icons on the target frame."] = "在目标框架上显示减益图标。"
L["Show debuff icons on the focus frame."] = "在焦点框架上显示减益图标。"
L["Show Buffs"] = "显示增益"
L["Show buff icons on the target frame."] = "在目标框架上显示增益图标。"
L["Show buff icons on the focus frame."] = "在焦点框架上显示增益图标。"
L["Show Group Indicator"] = "显示队伍指示器"
L["Show the raid subgroup indicator (e.g. Group 2) above the player frame."] = "在玩家框架上方显示团队分组指示器（如第2组）。"
L["Class Color Name"] = "职业颜色名称"
L["Center Name"] = "居中名称"
L["Center the unit name above the health bar."] = "将单位名称居中显示在生命条上方。"
...
L["Choose where the combo widget is anchored on the target nameplate health bar."] = "选择连击点组件在目标姓名板生命条上的锚定位置。"
L["Scale of the combo widget (0.5 - 2.0)."] = "连击点组件的缩放 (0.5 - 2.0)。"
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "从所选锚点的水平偏移。负值向左移动，正值向右移动。"
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "从所选锚点的垂直偏移。负值向下移动，正值向上移动。"
L["Combos Per Row"] = "每行连击数"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "自定义职业资源（Reaper、Demonhunter、Ranger 等）每行最多显示的连击段数。潜行者和德鲁伊使用单个组合图标，不受影响。超出时换到第二行。"
...
L["Debuff position reset."] = "减益位置已重置。"
L["Debuffs detached - positioned freely via Editor Mode"] = "减益已分离 - 可通过编辑模式自由定位"
L["Debuffs attached - follow buff row"] = "减益已附着 - 跟随增益行"
L["Lock Toggle Hotkey"] = "锁定切换快捷键"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "选择在悬停背包格子时用于锁定或解锁的修饰键 + 鼠标按键。"
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "使用 /sortlock 从聊天框锁定或解锁当前悬停的格子。"
L["Alt + Left Click"] = "Alt + 左键单击"
L["Ctrl + Left Click"] = "Ctrl + 左键单击"
L["Shift + Left Click"] = "Shift + 左键单击"
L["Alt + Right Click"] = "Alt + 右键单击"
L["Ctrl + Right Click"] = "Ctrl + 右键单击"
L["Shift + Right Click"] = "Shift + 右键单击"
L["Alt + Middle Click"] = "Alt + 中键单击"
L["Ctrl + Middle Click"] = "Ctrl + 中键单击"
L["Shift + Middle Click"] = "Shift + 中键单击"
L["Extra Bar Scale"] = "额外动作条缩放"
L["Bar"] = "动作条"
L["Hide the main bar while in combat."] = "战斗中隐藏主动作条。"
L["Fade the quest tracker until you hover over it."] = "在你悬停之前淡出任务追踪器。"
L["Fade the quest tracker until you enter combat."] = "在你进入战斗之前淡出任务追踪器。"
L["Hide the quest tracker while in combat."] = "战斗中隐藏任务追踪器。"
L["Fade the XP and Reputation bars until you hover over them."] = "在你悬停之前淡出经验值和声望条。"
L["Fade the XP and Reputation bars until you enter combat."] = "在你进入战斗之前淡出经验值和声望条。"
L["Hide the XP and Reputation bars while in combat."] = "战斗中隐藏经验值和声望条。"
L["Fade the player frame until you hover over it."] = "在你悬停之前淡出玩家框架。"
L["Fade the player frame until you enter combat."] = "在你进入战斗之前淡出玩家框架。"
L["Also fades the Target of Target and target cast bar, attached or not."] = "同时淡出目标的目标和目标施法条，无论是否附着。"
L["Fade the target frame group until you hover over it."] = "在你悬停之前淡出目标框架组。"
L["Fade the target frame group until you enter combat."] = "在你进入战斗之前淡出目标框架组。"
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "同时淡出焦点的目标和焦点施法条，无论是否附着。"
L["Fade the focus frame group until you hover over it."] = "在你悬停之前淡出焦点框架组。"
L["Fade the focus frame group until you enter combat."] = "在你进入战斗之前淡出焦点框架组。"
L["Fade the pet frame until you hover over it."] = "在你悬停之前淡出宠物框架。"
L["Fade the pet frame until you enter combat."] = "在你进入战斗之前淡出宠物框架。"
L["Fade party frames until you hover over them."] = "在你悬停之前淡出队伍框架。"
L["Fade party frames until you enter combat."] = "在你进入战斗之前淡出队伍框架。"
L["Fade boss frames until you hover over them."] = "在你悬停之前淡出首领框架。"
L["Fade boss frames until you enter combat."] = "在你进入战斗之前淡出首领框架。"
L["Boss"] = "首领"
L["Fade the stance bar until you hover over it."] = "在你悬停之前淡出姿态条。"
L["Fade the stance bar until you enter combat."] = "在你进入战斗之前淡出姿态条。"
L["Fade the pet bar until you hover over it."] = "在你悬停之前淡出宠物动作条。"
L["Fade the pet bar until you enter combat."] = "在你进入战斗之前淡出宠物动作条。"
L["Fade the totem bar until you hover over it."] = "在你悬停之前淡出图腾条。"
L["Fade the totem bar until you enter combat."] = "在你进入战斗之前淡出图腾条。"
L["Fade the minimap until you hover over it."] = "在你悬停之前淡出小地图。"
L["Fade the minimap until you enter combat."] = "在你进入战斗之前淡出小地图。"
L["Experimental:"] = "实验性："
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "淡出小地图偶尔会导致追踪图标在你执行 /reload 之前停止更新。使用风险自负。"
...
L["Show Stance Bar"] = "显示姿态条"
L["Show Totem Bar"] = "显示图腾条"
L["Configure how DragonUI notifies you when friends come online or go offline."] = "配置当好友上线或离线时 DragonUI 通知你的方式。"
L["Enable BNet Toast"] = "启用 BNet 通知"
L["Display Battle.net friend online/offline notifications via toast popup and/or chat messages."] = "通过弹出通知和/或聊天消息显示 Battle.net 好友上线/离线通知。"
L["Notification Type"] = "通知类型"
L["Guild Notifications"] = "公会通知"
L["Show notifications for guild members coming online or going offline. Turn off to only receive friend notifications."] = "当公会成员上线或离线时显示通知。关闭后仅接收好友通知。"
L["Show Toast Popup"] = "显示弹出通知"
L["Display the Battle.net toast frame when a friend comes online or goes offline."] = "当好友上线或离线时显示 Battle.net 通知框。"
L["Show Chat Notification"] = "显示聊天通知"
L["Display a chat message when a friend comes online or goes offline."] = "当好友上线或离线时显示聊天消息。"
L["Share to:"] = "分享至："
L["Whisper"] = "密语"
L["Raid"] = "团队"
L["Guild"] = "公会"
L["Share"] = "分享"
L["Enter a target player name for whisper."] = "输入要密语的目标玩家名称。"
L["Profile shared with"] = "配置文件已分享给"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "使用战斗记录来推测你未选定单位的施法。精确度低于上方的目标、焦点、鼠标悬停和竞技场敌人。"
L["Sync From Native Cast Bar"] = "从原生施法条同步"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "在受支持的客户端上，使用游戏内置的姓名板施法条以获得更好的时机。可安全保持启用。"
L["Native Progress Sync for Off-Target Casts"] = "非目标施法的原生进度同步"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "如果可用，非目标战斗记录施法条会从暴雪原生施法条同步进度。"
L["showVKeyCastbar Mode"] = "showVKeyCastbar 模式"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto：保留客户端值。force_on/off：在姓名板模块激活时由 DragonUI 设置 showVKeyCastbar。"
L["Auto (Do Not Force)"] = "自动（不强制）"
L["Force On"] = "强制开启"
L["Force Off"] = "强制关闭"
L["DragonUI (Custom)"] = "DragonUI（自定义）"
L["Transmog Collector"] = "幻化收集器"
L["Enable Transmog Collector"] = "启用幻化收集器"
L["Automatically collect transmog appearances when looting new items. Works with Ascension's Ctrl+Alt+Click appearance system."] = "在拾取新物品时自动收集幻化外观。与 Ascension 的 Ctrl+Alt+单击外观系统兼容。"
L["On loot, auto-collects appearances for items you haven't learned yet."] = "拾取时自动收集你尚未学会的物品外观。"
L["Attack Bar"] = "攻击条"
L["Shows swing timers for your main hand, off hand, ranged attacks, and enemy target melee swings."] = "显示你的主手、副手、远程攻击以及敌方目标近战挥击的挥击计时器。"
L["Enable Attack Bar"] = "启用攻击条"
L["Show swing timer bars for melee and ranged attacks."] = "显示近战和远程攻击的挥击计时器条。"
L["Main Hand Bar"] = "主手条"
L["Show the main hand melee swing timer."] = "显示主手近战挥击计时器。"
L["Off Hand Bar"] = "副手条"
L["Show the off hand melee swing timer (dual-wield)."] = "显示副手近战挥击计时器（双持）。"
L["Ranged Bar"] = "远程条"
L["Show the ranged attack timer (Hunter shots, Throw, Aimed Shot)."] = "显示远程攻击计时器（猎人射击、投掷、瞄准射击）。"
L["Enemy Bar"] = "敌人条"
L["Show the enemy target melee swing timer."] = "显示敌方目标近战挥击计时器。"
L["Show Timer"] = "显示计时器"
L["Show the countdown timer text on bars."] = "在条上显示倒计时文字。"
L["Show Info"] = "显示信息"
L["Show spell name, damage range, and time remaining text."] = "显示法术名称、伤害范围和剩余时间文字。"
L["Choose the border style for the swing timer bars."] = "选择挥击计时器条的边框样式。"
L["Standard"] = "标准"
L["Thin"] = "细"
L["Scale of the swing timer bars."] = "挥击计时器条的缩放。"
L["Swing Timer Module"] = "挥击计时器模块"
L["Shows main hand, off hand, ranged, and enemy target swing timers."] = "显示主手、副手、远程和敌方目标的挥击计时器。"
...
L["World Map"] = "世界地图"
L["Retail-styled world map with breadcrumb navigation, drag-to-resize and quest log side panel. Requires a full /reload after toggling."] = "带有现代边框、面包屑导航、拖动调整大小和任务日志侧面板的世界地图。切换后需要完全 /reload。"
L["Enable World Map"] = "启用世界地图"
L["Activates the modern world map frame. Requires /reload to take effect."] = "激活现代世界地图框架。需要 /reload 生效。"
L["Enable Fog Reveal"] = "启用迷雾揭示"
L["Draw grey tint over undiscovered zones using account-wide exploration data. Each alt sees your main's exploration immediately."] = "使用账号范围内的探索数据在未发现区域上绘制灰色遮罩。"
L["Enable Wheel Zoom"] = "启用滚轮缩放"
L["Mouse wheel zooms and pans the map canvas."] = "鼠标滚轮缩放和平移地图画布。"
-- World Map
L["World Map"] = "世界地图"
...
-- About Authors
L["Worked on by MiiKiis for the WoW Hollow server."] = "由 MiiKiis 为 WoW Hollow 服务器开发。"
L["Original work by Neticsoul, with contributions by PentSec and the community."] = "基于 Neticsoul 的原作，以及 PentSec 和社区的贡献。"
