...
L["Ignore Keeper's Aura from Target"] = "대상의 키퍼 오라 무시"
L["Hide all buffs on the target whose name starts with 'Keeper's'."] = "이름이 'Keeper's'로 시작하는 대상의 모든 버프를 숨깁니다."
...
L["Hide Castbar"] = "시전 바 숚기기"
L["Hide Castbar Desc"] = "이 시전 바를 완전히 숚깁니다: DragonUI 바와 블리자드 기본 바 모두 숚겨집니다."
L["Show Icon"] = "아이콘 표시"
...
L["Square Minimap"] = "정사각형 미니맵"
L["Use a square minimap with a square border instead of the round DragonUI border."] = "둥근 DragonUI 테두리 대신 정사각형 테두리가 있는 정사각형 미니맵을 사용합니다."
...
L["Add item level, PvE/PvP power and prestige for player units."] = "플레이어 유닛에 대해 아이템 레벨, PvE/PvP 전투력 및 프레스티지를 추가합니다."
...
L["No position presets saved yet. Save one in Edit Mode (/dragonui edit) first."] = "저장된 위치 프리셋이 없습니다. 먼저 편집 모드(/dragonui edit)에서 저장하세요."
L["Position presets not available."] = "위치 프리셋을 사용할 수 없습니다."
...
L["Not a valid DragonUI profile string."] = "유효한 DragonUI 프로필 문자열이 아닙니다."
...
L["Show debuff icons on the target frame."] = "대상 프레임에 디버프 아이콘을 표시합니다."
L["Show debuff icons on the focus frame."] = "초점 프레임에 디버프 아이콘을 표시합니다."
L["Show Buffs"] = "버프 표시"
L["Show buff icons on the target frame."] = "대상 프레임에 버프 아이콘을 표시합니다."
L["Show buff icons on the focus frame."] = "초점 프레임에 버프 아이콘을 표시합니다."
L["Show Group Indicator"] = "그룹 표시기 표시"
L["Show the raid subgroup indicator (e.g. Group 2) above the player frame."] = "플레이어 프레임 위에 공격대 하위 그룹 표시기(예: 그룹 2)를 표시합니다."
L["Class Color Name"] = "직업 색상 이름"
L["Center Name"] = "이름 중앙 정렬"
L["Center the unit name above the health bar."] = "유닛 이름을 생명력 바 위에 중앙 정렬합니다."
...
L["Choose where the combo widget is anchored on the target nameplate health bar."] = "대상 이름표의 체력 바에서 연계 점수 위젯이 고정될 위치를 선택합니다."
L["Scale of the combo widget (0.5 - 2.0)."] = "연계 점수 위젯 크기 (0.5 - 2.0)."
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "선택한 고정 지점에서의 가로 오프셋입니다. 음수는 왼쪽, 양수는 오른쪽으로 이동합니다."
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "선택한 고정 지점에서의 세로 오프셋입니다. 음수는 아래로, 양수는 위로 이동합니다."
L["Combos Per Row"] = "행당 콤보 수"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "사용자 지정 클래스 자원(Reaper, Demonhunter, Ranger 등)에서 행당 최대 콤보 세그먼트 수입니다. 도적과 드루이드는 단일 결합 아이콘을 사용하므로 영향을 받지 않습니다. 초과 시 두 번째 행으로 넘어갑니다."
...
L["Enable Aura Borders"] = "오라 테두리 활성화"
L["Show modern borders around buff and debuff icons."] = "강화 및 약화 효과 아이콘 주위에 현대적인 테두리를 표시합니다."
L["Buff Border Color"] = "강화 효과 테두리 색상"
L["Reset Debuff Position"] = "약화 효과 위치 초기화"
L["Debuff position reset."] = "약화 효과 위치가 초기화되었습니다."
L["Debuffs detached - positioned freely via Editor Mode"] = "약화 효과 분리됨 - 편집 모드로 자유롭게 배치"
L["Debuffs attached - follow buff row"] = "약화 효과 부착됨 - 강화 효과 줄을 따름"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "마우스를 올리지 않았을 때 탭, 버튼 및 대화 배경의 불투명도입니다. 0 = 숨김, 1 = 항상 표시."
L["Lock Toggle Hotkey"] = "잠금 전환 단축키"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "가방 칸에 마우스를 올렸을 때 잠그거나 잠금 해제하는 데 사용할 조합 키 + 마우스 버튼을 선택합니다."
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "/sortlock를 사용하여 현재 마우스를 올린 칸을 대화창에서 잠그거나 잠금 해제합니다."
...
L["Bar"] = "바"
L["Hide the main bar while in combat."] = "전투 중 주 바를 숨깁니다."
L["Fade the quest tracker until you hover over it."] = "마우스를 올릴 때까지 퀘스트 추적기를 흐리게 합니다."
L["Fade the quest tracker until you enter combat."] = "전투에 돌입할 때까지 퀘스트 추적기를 흐리게 합니다."
L["Hide the quest tracker while in combat."] = "전투 중 퀘스트 추적기를 숨깁니다."
L["Fade the XP and Reputation bars until you hover over them."] = "마우스를 올릴 때까지 경험치 및 평판 바를 흐리게 합니다."
L["Fade the XP and Reputation bars until you enter combat."] = "전투에 돌입할 때까지 경험치 및 평판 바를 흐리게 합니다."
L["Hide the XP and Reputation bars while in combat."] = "전투 중 경험치 및 평판 바를 숨깁니다."
L["Fade the player frame until you hover over it."] = "마우스를 올릴 때까지 플레이어 프레임을 흐리게 합니다."
L["Fade the player frame until you enter combat."] = "전투에 돌입할 때까지 플레이어 프레임을 흐리게 합니다."
L["Also fades the Target of Target and target cast bar, attached or not."] = "부착 여부와 관계없이 대상의 대상과 대상 시전 바도 함께 흐리게 합니다."
L["Fade the target frame group until you hover over it."] = "마우스를 올릴 때까지 대상 프레임 그룹을 흐리게 합니다."
L["Fade the target frame group until you enter combat."] = "전투에 돌입할 때까지 대상 프레임 그룹을 흐리게 합니다."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "부착 여부와 관계없이 주시 대상의 대상과 주시 대상 시전 바도 함께 흐리게 합니다."
L["Fade the focus frame group until you hover over it."] = "마우스를 올릴 때까지 주시 대상 프레임 그룹을 흐리게 합니다."
L["Fade the focus frame group until you enter combat."] = "전투에 돌입할 때까지 주시 대상 프레임 그룹을 흐리게 합니다."
L["Fade the pet frame until you hover over it."] = "마우스를 올릴 때까지 소환수 프레임을 흐리게 합니다."
L["Fade the pet frame until you enter combat."] = "전투에 돌입할 때까지 소환수 프레임을 흐리게 합니다."
L["Fade party frames until you hover over them."] = "마우스를 올릴 때까지 파티 프레임을 흐리게 합니다."
L["Fade party frames until you enter combat."] = "전투에 돌입할 때까지 파티 프레임을 흐리게 합니다."
L["Fade boss frames until you hover over them."] = "마우스를 올릴 때까지 우두머리 프레임을 흐리게 합니다."
L["Fade boss frames until you enter combat."] = "전투에 돌입할 때까지 우두머리 프레임을 흐리게 합니다."
L["Boss"] = "우두머리"
L["Fade the stance bar until you hover over it."] = "마우스를 올릴 때까지 태세 바를 흐리게 합니다."
L["Fade the stance bar until you enter combat."] = "전투에 돌입할 때까지 태세 바를 흐리게 합니다."
L["Fade the pet bar until you hover over it."] = "마우스를 올릴 때까지 소환수 바를 흐리게 합니다."
L["Fade the pet bar until you enter combat."] = "전투에 돌입할 때까지 소환수 바를 흐리게 합니다."
L["Fade the totem bar until you hover over it."] = "마우스를 올릴 때까지 토템 바를 흐리게 합니다."
L["Fade the totem bar until you enter combat."] = "전투에 돌입할 때까지 토템 바를 흐리게 합니다."
L["Fade the minimap until you hover over it."] = "마우스를 올릴 때까지 미니맵을 흐리게 합니다."
L["Fade the minimap until you enter combat."] = "전투에 돌입할 때까지 미니맵을 흐리게 합니다."
L["Experimental:"] = "실험적 기능:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "미니맵을 흐리게 하면 간혹 /reload 전까지 추적 아이콘이 갱신되지 않을 수 있습니다. 사용에 주의하십시오."
...
L["Hide the minimap while in combat."] = "전투 중 미니맵을 숨깁니다."
L["Show Stance Bar"] = "태세 바 표시"
L["Show Totem Bar"] = "토템 바 표시"
L["Configure how DragonUI notifies you when friends come online or go offline."] = "친구가 접속하거나 접속을 종료할 때 DragonUI가 알리는 방식을 설정합니다."
L["Enable BNet Toast"] = "BNet 알림 활성화"
L["Display Battle.net friend online/offline notifications via toast popup and/or chat messages."] = "Battle.net 친구의 접속/접속 종료 알림을 팝업 및/또는 대화 메시지로 표시합니다."
L["Notification Type"] = "알림 유형"
L["Guild Notifications"] = "길드 알림"
L["Show notifications for guild members coming online or going offline. Turn off to only receive friend notifications."] = "길드원이 접속하거나 접속을 종료할 때 알림을 표시합니다. 끄면 친구 알림만 받습니다."
L["Show Toast Popup"] = "팝업 알림 표시"
L["Display the Battle.net toast frame when a friend comes online or goes offline."] = "친구가 접속하거나 접속을 종료할 때 Battle.net 알림 프레임을 표시합니다."
L["Show Chat Notification"] = "대화 알림 표시"
L["Display a chat message when a friend comes online or goes offline."] = "친구가 접속하거나 접속을 종료할 때 대화 메시지를 표시합니다."
L["Share to:"] = "공유 대상:"
L["Whisper"] = "귓속말"
L["Raid"] = "공격대"
L["Guild"] = "길드"
L["Share"] = "공유"
L["Enter a target player name for whisper."] = "귓속말할 대상 플레이어 이름을 입력하십시오."
L["Profile shared with"] = "프로필을 공유한 대상:"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "전투 기록을 사용하여 대상으로 지정하지 않은 유닛의 시전을 추정합니다. 위의 대상, 주시 대상, 마우스 오버 및 투기장 적보다 정확도가 낮습니다."
L["Sync From Native Cast Bar"] = "기본 시전 바에서 동기화"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "지원되는 클라이언트에서 더 정확한 타이밍을 위해 게임 내장 이름표 시전 바를 사용합니다. 활성화 상태로 두어도 안전합니다."
L["Native Progress Sync for Off-Target Casts"] = "비대상 시전의 기본 진행 동기화"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "가능한 경우, 비대상 전투 기록 시전 바가 진행 상태를 Blizzard 기본 시전 바에서 동기화합니다."
L["showVKeyCastbar Mode"] = "showVKeyCastbar 모드"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: 클라이언트 값 유지. force_on/off: 이름표 모듈이 활성화된 동안 DragonUI가 showVKeyCastbar를 설정합니다."
L["Auto (Do Not Force)"] = "자동(강제 안 함)"
L["Force On"] = "강제 켬"
L["Force Off"] = "강제 끔"
L["DragonUI (Custom)"] = "DragonUI(사용자 지정)"
L["Transmog Collector"] = "형상변환 수집기"
L["Enable Transmog Collector"] = "형상변환 수집기 활성화"
L["Automatically collect transmog appearances when looting new items. Works with Ascension's Ctrl+Alt+Click appearance system."] = "새 아이템을 획득할 때 형상변환 외형을 자동으로 수집합니다. Ascension의 Ctrl+Alt+클릭 외형 시스템과 함께 작동합니다."
L["On loot, auto-collects appearances for items you haven't learned yet."] = "획득 시 아직 배우지 않은 아이템의 외형을 자동으로 수집합니다."
L["Attack Bar"] = "공격 바"
L["Shows swing timers for your main hand, off hand, ranged attacks, and enemy target melee swings."] = "주 무기, 보조 무기, 원거리 공격 및 적 대상의 근접 공격에 대한 타격 타이머를 표시합니다."
L["Enable Attack Bar"] = "공격 바 활성화"
L["Show swing timer bars for melee and ranged attacks."] = "근접 및 원거리 공격의 타격 타이머 바를 표시합니다."
L["Main Hand Bar"] = "주 무기 바"
L["Show the main hand melee swing timer."] = "주 무기 근접 타격 타이머를 표시합니다."
L["Off Hand Bar"] = "보조 무기 바"
L["Show the off hand melee swing timer (dual-wield)."] = "보조 무기 근접 타격 타이머를 표시합니다(쌍수)."
L["Ranged Bar"] = "원거리 바"
L["Show the ranged attack timer (Hunter shots, Throw, Aimed Shot)."] = "원거리 공격 타이머를 표시합니다(사냥꾼 사격, 투척, 조준 사격)."
L["Enemy Bar"] = "적 바"
L["Show the enemy target melee swing timer."] = "적 대상의 근접 타격 타이머를 표시합니다."
L["Show Timer"] = "타이머 표시"
L["Show the countdown timer text on bars."] = "바에 카운트다운 타이머 문구를 표시합니다."
L["Show Info"] = "정보 표시"
L["Show spell name, damage range, and time remaining text."] = "주문 이름, 피해량 범위 및 남은 시간 문구를 표시합니다."
L["Choose the border style for the swing timer bars."] = "타격 타이머 바의 테두리 스타일을 선택합니다."
L["Standard"] = "표준"
L["Thin"] = "얇게"
L["Scale of the swing timer bars."] = "타격 타이머 바의 크기입니다."
L["Swing Timer Module"] = "타격 타이머 모듈"
L["Shows main hand, off hand, ranged, and enemy target swing timers."] = "주 무기, 보조 무기, 원거리 및 적 대상 타격 타이머를 표시합니다."
...
-- About Authors
L["Worked on by MiiKiis for the WoW Hollow server."] = "WoW Hollow 서버를 위해 MiiKiis가 작업함."
L["Original work by Neticsoul, with contributions by PentSec and the community."] = "Neticsoul의 원본 작업, PentSec 및 커뮤니티의 기여."
