...
L["Ignore Keeper's Aura from Target"] = "Ignorar Aura de Keeper del Objetivo"
L["Hide all buffs on the target whose name starts with 'Keeper's'."] = "Ocultar todos los efectos positivos del objetivo cuyo nombre comience con 'Keeper's'."
...
L["Disable Form Page Switching"] = "Desactivar Cambio de Página por Forma"
L["When enabled, the main action bar stays on the same page regardless of stance/form changes. Useful for druids, warriors, and CoA Classes who prefer manual page management."] = "Al activarlo, la barra de acción principal se mantiene en la misma página sin importar los cambios de postura/forma. Útil para druidas, guerreros y clases de CoA que prefieren gestionar las páginas manualmente."
...
L["Hide Castbar"] = "Ocultar barra de lanzamiento"
L["Hide Castbar Desc"] = "Oculta completamente esta barra de lanzamiento: tanto la de DragonUI como la predeterminada de Blizzard."
...
L["Use a square minimap with a square border instead of the round DragonUI border."] = "Usa un minimapa cuadrado con borde cuadrado en lugar del borde redondo de DragonUI."
...
L["Add item level, PvE/PvP power and prestige for player units."] = "Añade nivel de objeto, poder PvE/PvP y prestigio para unidades de jugador."
...
L["Manage your current profile: reset to defaults, export/import as text, or share in-game."] = "Administra tu perfil actual: restablece a valores predeterminados, exporta/importa como texto, o comparte en el juego."
L["Restores the current profile to defaults."] = "Restaura el perfil actual a sus valores predeterminados."
L["Export your current profile as a text string."] = "Exporta tu perfil actual como un texto."
...
L["No position presets saved yet. Save one in Edit Mode (/dragonui edit) first."] = "Aún no hay preajustes de posición guardados. Guarda uno primero en el modo de edición (/dragonui edit)."
L["Position presets not available."] = "Preajustes de posición no disponibles."
...
L["Sending..."] = "Enviando..."
L["Failed to export profile."] = "Error al exportar el perfil."
L["Import a profile from a text string shared by another user."] = "Importa un perfil desde un texto compartido por otro usuario."
L["Invalid profile string."] = "Texto de perfil no válido."
L["Not a valid DragonUI profile string."] = "No es un texto de perfil DragonUI válido."
...
L["This Fork is maintained by PentSec for AscensionWow, based on the original work by Neticsoul."] = "Este Fork es mantenido por MiiKiis para WoW-Hollow, basado en el trabajo original de Neticsoul."
...
L["Show debuff icons on the target frame."] = "Mostrar iconos de debuffs en el marco del objetivo."
L["Show debuff icons on the focus frame."] = "Mostrar iconos de debuffs en el marco del foco."
L["Show Buffs"] = "Mostrar buffs"
L["Show buff icons on the target frame."] = "Mostrar iconos de buffs en el marco del objetivo."
L["Show buff icons on the focus frame."] = "Mostrar iconos de buffs en el marco del foco."
L["Show Group Indicator"] = "Mostrar indicador de grupo"
L["Show the raid subgroup indicator (e.g. Group 2) above the player frame."] = "Mostrar el indicador de subgrupo de banda (ej. Grupo 2) sobre el marco del jugador."
L["Class Color Name"] = "Nombre con color de clase"
L["Center Name"] = "Centrar nombre"
L["Center the unit name above the health bar."] = "Centrar el nombre de la unidad sobre la barra de vida."
...
L["Anchor Position"] = "Posición de anclaje"
L["Choose where the combo widget is anchored on the target nameplate health bar."] = "Elige dónde se ancla el widget de puntos de combo en la barra de vida de la placa del objetivo."
L["Scale of the combo widget (0.5 - 2.0)."] = "Escala del widget de puntos de combo (0.5 - 2.0)."
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "Desplazamiento horizontal desde el punto de anclaje elegido. Negativo mueve a la izquierda, positivo a la derecha."
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "Desplazamiento vertical desde el punto de anclaje elegido. Negativo mueve hacia abajo, positivo hacia arriba."
L["Combos Per Row"] = "Combos por fila"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "Máximo de segmentos de combo por fila en recursos de clases personalizadas (Reaper, Demonhunter, Ranger, ...). Pícaro y Druida usan un único icono combinado y no se ven afectados. Pasa a una segunda fila cuando se excede."
...
L["Show modern borders around buff and debuff icons."] = "Mostrar bordes modernos alrededor de los iconos de beneficios y perjuicios."
...
L["Debuffs detached - positioned freely via Editor Mode"] = "Perjuicios separados: se colocan libremente mediante el modo editor"
L["Debuffs attached - follow buff row"] = "Perjuicios anclados: siguen la fila de beneficios"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Opacidad de las pestañas, botones y fondo del chat cuando no se pasa el cursor. 0 = oculto, 1 = siempre visible."
L["Equipment"] = "Equipo"
L["Usable"] = "Utilizable"
L["Extra Bar Scale"] = "Escala de la barra extra"
L["Bar"] = "Barra"
L["Hide the main bar while in combat."] = "Ocultar la barra principal durante el combate."
L["Fade the quest tracker until you hover over it."] = "Atenuar el rastreador de misiones hasta que pases el cursor sobre él."
L["Fade the quest tracker until you enter combat."] = "Atenuar el rastreador de misiones hasta que entres en combate."
L["Hide the quest tracker while in combat."] = "Ocultar el rastreador de misiones durante el combate."
L["Fade the XP and Reputation bars until you hover over them."] = "Atenuar las barras de experiencia y reputación hasta que pases el cursor sobre ellas."
L["Fade the XP and Reputation bars until you enter combat."] = "Atenuar las barras de experiencia y reputación hasta que entres en combate."
L["Hide the XP and Reputation bars while in combat."] = "Ocultar las barras de experiencia y reputación durante el combate."
L["Fade the player frame until you hover over it."] = "Atenuar el marco del jugador hasta que pases el cursor sobre él."
L["Fade the player frame until you enter combat."] = "Atenuar el marco del jugador hasta que entres en combate."
L["Also fades the Target of Target and target cast bar, attached or not."] = "También atenúa el objetivo del objetivo y la barra de conjuro del objetivo, estén ancladas o no."
L["Fade the target frame group until you hover over it."] = "Atenuar el grupo del marco del objetivo hasta que pases el cursor sobre él."
L["Fade the target frame group until you enter combat."] = "Atenuar el grupo del marco del objetivo hasta que entres en combate."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "También atenúa el objetivo del foco y la barra de conjuro del foco, estén ancladas o no."
L["Fade the focus frame group until you hover over it."] = "Atenuar el grupo del marco del foco hasta que pases el cursor sobre él."
L["Fade the focus frame group until you enter combat."] = "Atenuar el grupo del marco del foco hasta que entres en combate."
L["Fade the pet frame until you hover over it."] = "Atenuar el marco de la mascota hasta que pases el cursor sobre él."
L["Fade the pet frame until you enter combat."] = "Atenuar el marco de la mascota hasta que entres en combate."
L["Fade party frames until you hover over them."] = "Atenuar los marcos del grupo hasta que pases el cursor sobre ellos."
L["Fade party frames until you enter combat."] = "Atenuar los marcos del grupo hasta que entres en combate."
L["Fade boss frames until you hover over them."] = "Atenuar los marcos de jefe hasta que pases el cursor sobre ellos."
L["Fade boss frames until you enter combat."] = "Atenuar los marcos de jefe hasta que entres en combate."
L["Boss"] = "Jefe"
L["Fade the stance bar until you hover over it."] = "Atenuar la barra de actitud hasta que pases el cursor sobre ella."
L["Fade the stance bar until you enter combat."] = "Atenuar la barra de actitud hasta que entres en combate."
L["Fade the pet bar until you hover over it."] = "Atenuar la barra de mascota hasta que pases el cursor sobre ella."
L["Fade the pet bar until you enter combat."] = "Atenuar la barra de mascota hasta que entres en combate."
L["Fade the totem bar until you hover over it."] = "Atenuar la barra de tótems hasta que pases el cursor sobre ella."
L["Fade the totem bar until you enter combat."] = "Atenuar la barra de tótems hasta que entres en combate."
L["Fade the minimap until you hover over it."] = "Atenuar el minimapa hasta que pases el cursor sobre él."
L["Fade the minimap until you enter combat."] = "Atenuar el minimapa hasta que entres en combate."
L["Experimental:"] = "Experimental:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Atenuar el minimapa puede provocar ocasionalmente que los iconos de rastreo dejen de actualizarse hasta que uses /reload. Úsalo bajo tu propio riesgo."
...
L["Hide the minimap while in combat."] = "Ocultar el minimapa durante el combate."
L["Show Stance Bar"] = "Mostrar barra de actitud"
L["Show Totem Bar"] = "Mostrar barra de tótems"
L["Configure how DragonUI notifies you when friends come online or go offline."] = "Configura cómo te notifica DragonUI cuando tus amigos se conectan o desconectan."
L["Enable BNet Toast"] = "Activar aviso de BNet"
L["Display Battle.net friend online/offline notifications via toast popup and/or chat messages."] = "Mostrar notificaciones de conexión/desconexión de amigos de Battle.net mediante aviso emergente o mensajes de chat."
L["Notification Type"] = "Tipo de notificación"
L["Guild Notifications"] = "Notificaciones de hermandad"
L["Show notifications for guild members coming online or going offline. Turn off to only receive friend notifications."] = "Muestra notificaciones cuando miembros de la hermandad se conectan o desconectan. Desactívalo para recibir solo notificaciones de amigos."
L["Show Toast Popup"] = "Mostrar aviso emergente"
L["Display the Battle.net toast frame when a friend comes online or goes offline."] = "Mostrar el marco de aviso de Battle.net cuando un amigo se conecta o desconecta."
L["Show Chat Notification"] = "Mostrar notificación de chat"
L["Display a chat message when a friend comes online or goes offline."] = "Mostrar un mensaje de chat cuando un amigo se conecta o desconecta."
L["Share to:"] = "Compartir con:"
L["Whisper"] = "Susurro"
L["Raid"] = "Banda"
L["Guild"] = "Hermandad"
L["Share"] = "Compartir"
L["Enter a target player name for whisper."] = "Introduce el nombre de un jugador objetivo para susurrar."
L["Profile shared with"] = "Perfil compartido con"
L["Enable Nameplates"] = "Activar placas de identificación"
L["Enable or disable the DragonUI nameplate module."] = "Activar o desactivar el módulo de placas de identificación de DragonUI."
L["DragonUI-style health bars on Blizzard nameplates (30300)."] = "Barras de vida al estilo DragonUI en las placas de identificación de Blizzard (30300)."
L["Show Level in Name"] = "Mostrar nivel en el nombre"
L["Side arrows on the targeted nameplate."] = "Flechas laterales en la placa de identificación del objetivo."
L["Bar Size"] = "Tamaño de la barra"
L["Width of the nameplate health bar."] = "Anchura de la barra de vida de la placa de identificación."
L["Height of the nameplate health bar."] = "Altura de la barra de vida de la placa de identificación."
L["Name and health percent font scale (1-10)."] = "Escala de fuente del nombre y del porcentaje de vida (1-10)."
L["Stack Offset X"] = "Desplazamiento X de pila"
L["Horizontal offset for the nameplate stack."] = "Desplazamiento horizontal de la pila de placas de identificación."
L["Stack Offset Y"] = "Desplazamiento Y de pila"
L["Vertical offset for the nameplate stack."] = "Desplazamiento vertical de la pila de placas de identificación."
L["Highlight texture on the targeted nameplate."] = "Textura de resaltado en la placa de identificación del objetivo."
L["Opacity for non-target nameplates when fade is enabled (0.0-1.0)."] = "Opacidad de las placas de identificación que no son el objetivo cuando la atenuación está activada (0.0-1.0)."
L["Hide mana/power on NPC nameplates when unit is known."] = "Ocultar maná/energía en las placas de identificación de PNJ cuando se conoce la unidad."
L["On 3.3.5a, enemy cast bars appear on the targeted plate only."] = "En 3.3.5a, las barras de conjuro enemigas aparecen solo en la placa del objetivo."
L["Sync From Native Cast Bar"] = "Sincronizar desde la barra de conjuro nativa"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "En clientes compatibles, usar la barra de conjuro de placa de identificación integrada del juego para mejor precisión. Es seguro dejarlo activado."
L["Native Progress Sync for Off-Target Casts"] = "Sincronización de progreso nativa para conjuros sin objetivo"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "Cuando está disponible, las barras de conjuro del registro de combate sin objetivo sincronizan su progreso con la barra de conjuro nativa de Blizzard."
L["showVKeyCastbar Mode"] = "Modo showVKeyCastbar"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: mantener el valor del cliente. force_on/off: DragonUI establece showVKeyCastbar mientras el módulo de placas está activo."
...
L["Enable Attack Bar"] = "Activar barra de ataque"
L["Show swing timer bars for melee and ranged attacks."] = "Mostrar barras de temporizador de golpe para ataques cuerpo a cuerpo y a distancia."
L["Main Hand Bar"] = "Barra de mano principal"
L["Show the main hand melee swing timer."] = "Mostrar el temporizador de golpe cuerpo a cuerpo de la mano principal."
L["Off Hand Bar"] = "Barra de mano secundaria"
L["Show the off hand melee swing timer (dual-wield)."] = "Mostrar el temporizador de golpe cuerpo a cuerpo de la mano secundaria (doble empuñadura)."
L["Ranged Bar"] = "Barra a distancia"
L["Show the ranged attack timer (Hunter shots, Throw, Aimed Shot)."] = "Mostrar el temporizador de ataque a distancia (disparos de cazador, lanzamiento, disparo apuntado)."
L["Enemy Bar"] = "Barra de enemigo"
L["Show the enemy target melee swing timer."] = "Mostrar el temporizador de golpe cuerpo a cuerpo del objetivo enemigo."
L["Show Timer"] = "Mostrar temporizador"
L["Show the countdown timer text on bars."] = "Mostrar el texto de cuenta atrás en las barras."
L["Show Info"] = "Mostrar información"
L["Show spell name, damage range, and time remaining text."] = "Mostrar el nombre del hechizo, el rango de daño y el tiempo restante."
L["Choose the border style for the swing timer bars."] = "Elige el estilo de borde para las barras de temporizador de golpe."
L["Standard"] = "Estándar"
L["Thin"] = "Fino"
L["Scale of the swing timer bars."] = "Escala de las barras de temporizador de golpe."
L["Swing Timer Module"] = "Módulo de temporizador de golpe"
L["Shows main hand, off hand, ranged, and enemy target swing timers."] = "Muestra los temporizadores de golpe de mano principal, mano secundaria, distancia y objetivo enemigo."
...
L["|cffff5555Details! is not installed.|r This module skins the Details! Damage Meter, it is not a meter of its own - with Details! absent there is nothing to skin."] = "|cffff5555Details! no está instalado.|r Este módulo cambia la apariencia del medidor de daño Details!, no es un medidor propio - sin Details! no hay nada que modificar."
L["A retail-styled theme for |cffffcc55Details!|r, drawn with art from retail's own damage meter: a gold-titled header bar, class-coloured bars on a near-invisible panel, and abbreviated numbers. It is registered with Details! at login, so it also appears in Details!' own skin list under |cffffcc55DragonUI|r."] = "Un tema con estilo retail para |cffffcc55Details!|r, dibujado con arte del medidor de daño del retail: barra de título dorada, barras con colores de clase sobre un panel casi invisible y números abreviados. Se registra en Details! al iniciar sesión, así que también aparece en la lista de skins de Details! como |cffffcc55DragonUI|r."
L["Enable Damage Meter Skin"] = "Activar la skin del medidor de daño"
L["Registers the DragonUI theme with Details! and puts your chosen skin back after a reload. Turning it off hands every window back to Details!' own chrome."] = "Registra el tema DragonUI en Details! y restablece tu skin elegida tras un /reload. Al desactivarlo, todas las ventanas vuelven a la apariencia de Details!."
...
-- About Authors
L["Worked on by MiiKiis for the WoW Hollow server."] = "Trabajado por MiiKiis para el servidor de WoW Hollow."
L["Original work by Neticsoul, with contributions by PentSec and the community."] = "Trabajo original de Neticsoul, con contribuciones de PentSec y la comunidad."
