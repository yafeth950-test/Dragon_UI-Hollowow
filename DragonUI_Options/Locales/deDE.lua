...
L["Ignore Keeper's Aura from Target"] = "Keeper-Aura des Ziels ignorieren"
L["Hide all buffs on the target whose name starts with 'Keeper's'."] = "Alle Stärkungseffekte des Ziels ausblenden, deren Name mit 'Keeper's' beginnt."
...
L["Hide Castbar"] = "Zauberleiste ausblenden"
L["Hide Castbar Desc"] = "Blendet diese Zauberleiste vollständig aus: sowohl die DragonUI-Leiste als auch die Standard-Leiste von Blizzard."
...
L["Square Minimap"] = "Quadratische Minimap"
L["Use a square minimap with a square border instead of the round DragonUI border."] = "Verwendet eine quadratische Minimap mit quadratischem Rahmen anstelle des runden DragonUI-Rahmens."
...
L["No position presets saved yet. Save one in Edit Mode (/dragonui edit) first."] = "Noch keine Positions-Vorlagen gespeichert. Speichere zuerst eine im Bearbeitungsmodus (/dragonui edit)."
L["Position presets not available."] = "Positions-Vorlagen nicht verfügbar."
...
L["Not a valid DragonUI profile string."] = "Kein gültiger DragonUI-Profil-String."
...
L["Show debuff icons on the target frame."] = "Debuff-Symbole auf dem Zielrahmen anzeigen."
L["Show debuff icons on the focus frame."] = "Debuff-Symbole auf dem Fokusrahmen anzeigen."
L["Show Buffs"] = "Buffs anzeigen"
L["Show buff icons on the target frame."] = "Buff-Symbole auf dem Zielrahmen anzeigen."
L["Show buff icons on the focus frame."] = "Buff-Symbole auf dem Fokusrahmen anzeigen."
L["Show Group Indicator"] = "Gruppenanzeige anzeigen"
L["Show the raid subgroup indicator (e.g. Group 2) above the player frame."] = "Den Gruppenindicator (z.B. Gruppe 2) über dem Spielerrahmen anzeigen."
L["Class Color Name"] = "Klassenfarbiger Name"
L["Center Name"] = "Namen zentrieren"
L["Center the unit name above the health bar."] = "Den Einheitenname über der Lebensleiste zentrieren."
...
L["Choose where the combo widget is anchored on the target nameplate health bar."] = "Wählen Sie, wo das Kombopunkte-Widget an der Gesundheitsleiste der Namensplakette des Ziels verankert wird."
L["Scale of the combo widget (0.5 - 2.0)."] = "Skalierung des Kombopunkte-Widgets (0,5 - 2,0)."
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "Horizontaler Abstand vom gewählten Ankerpunkt. Negativ verschiebt nach links, positiv nach rechts."
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "Vertikaler Abstand vom gewählten Ankerpunkt. Negativ verschiebt nach unten, positiv nach oben."
L["Combos Per Row"] = "Kombos pro Reihe"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "Maximale Kombopunkte pro Reihe bei Ressourcen von benutzerdefinierten Klassen (Reaper, Demonhunter, Ranger, ...). Schurke und Druide verwenden ein einzelnes kombiniertes Symbol und sind nicht betroffen. Beim Überschreiten in eine zweite Reihe umbrechen."
...
-- ============================================================================
L["Aura Borders"] = "Auren-Rahmen"
L["Enable Aura Borders"] = "Auren-Rahmen aktivieren"
L["Show modern borders around buff and debuff icons."] = "Moderne Rahmen um Stärkungs- und Schwächungssymbole anzeigen."
L["Buff Border Color"] = "Rahmenfarbe für Stärkungseffekte"
L["Reset Debuff Position"] = "Position der Schwächungseffekte zurücksetzen"
L["Debuff position reset."] = "Position der Schwächungseffekte zurückgesetzt."
L["Debuffs detached - positioned freely via Editor Mode"] = "Schwächungseffekte gelöst - frei über den Editor-Modus positionierbar"
L["Debuffs attached - follow buff row"] = "Schwächungseffekte angeheftet - folgen der Stärkungsreihe"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Deckkraft von Reitern, Schaltflächen und Chat-Hintergrund, wenn nicht überfahren. 0 = versteckt, 1 = immer sichtbar."
L["Lock Toggle Hotkey"] = "Tastenkürzel zum Sperren umschalten"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "Wähle die Kombination aus Zusatztaste und Maustaste, um einen Taschenplatz beim Überfahren zu sperren oder zu entsperren."
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "Verwende /sortlock, um den gerade überfahrenen Platz über den Chat zu sperren oder zu entsperren."
...
L["Bar"] = "Leiste"
L["Hide the main bar while in combat."] = "Die Hauptleiste im Kampf ausblenden."
L["Fade the quest tracker until you hover over it."] = "Den Quest-Verfolger ausblenden, bis du ihn überfährst."
L["Fade the quest tracker until you enter combat."] = "Den Quest-Verfolger ausblenden, bis du in den Kampf gehst."
L["Hide the quest tracker while in combat."] = "Den Quest-Verfolger im Kampf ausblenden."
L["Fade the XP and Reputation bars until you hover over them."] = "Die EP- und Rufleisten ausblenden, bis du sie überfährst."
L["Fade the XP and Reputation bars until you enter combat."] = "Die EP- und Rufleisten ausblenden, bis du in den Kampf gehst."
L["Hide the XP and Reputation bars while in combat."] = "Die EP- und Rufleisten im Kampf ausblenden."
L["Fade the player frame until you hover over it."] = "Das Spielerfenster ausblenden, bis du es überfährst."
L["Fade the player frame until you enter combat."] = "Das Spielerfenster ausblenden, bis du in den Kampf gehst."
L["Also fades the Target of Target and target cast bar, attached or not."] = "Blendet auch das Ziel des Ziels und die Zielzauberleiste aus, ob angeheftet oder nicht."
L["Fade the target frame group until you hover over it."] = "Die Zielfenstergruppe ausblenden, bis du sie überfährst."
L["Fade the target frame group until you enter combat."] = "Die Zielfenstergruppe ausblenden, bis du in den Kampf gehst."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "Blendet auch das Ziel des Fokus und die Fokuszauberleiste aus, ob angeheftet oder nicht."
L["Fade the focus frame group until you hover over it."] = "Die Fokusfenstergruppe ausblenden, bis du sie überfährst."
L["Fade the focus frame group until you enter combat."] = "Die Fokusfenstergruppe ausblenden, bis du in den Kampf gehst."
L["Fade the pet frame until you hover over it."] = "Das Begleiterfenster ausblenden, bis du es überfährst."
L["Fade the pet frame until you enter combat."] = "Das Begleiterfenster ausblenden, bis du in den Kampf gehst."
L["Fade party frames until you hover over them."] = "Die Gruppenfenster ausblenden, bis du sie überfährst."
L["Fade party frames until you enter combat."] = "Die Gruppenfenster ausblenden, bis du in den Kampf gehst."
L["Fade boss frames until you hover over them."] = "Die Bossfenster ausblenden, bis du sie überfährst."
L["Fade boss frames until you enter combat."] = "Die Bossfenster ausblenden, bis du in den Kampf gehst."
L["Boss"] = "Boss"
L["Fade the stance bar until you hover over it."] = "Die Haltungsleiste ausblenden, bis du sie überfährst."
L["Fade the stance bar until you enter combat."] = "Die Haltungsleiste ausblenden, bis du in den Kampf gehst."
L["Fade the pet bar until you hover over it."] = "Die Begleiterleiste ausblenden, bis du sie überfährst."
L["Fade the pet bar until you enter combat."] = "Die Begleiterleiste ausblenden, bis du in den Kampf gehst."
L["Fade the totem bar until you hover over it."] = "Die Totemleiste ausblenden, bis du sie überfährst."
L["Fade the totem bar until you enter combat."] = "Die Totemleiste ausblenden, bis du in den Kampf gehst."
L["Fade the minimap until you hover over it."] = "Die Minikarte ausblenden, bis du sie überfährst."
L["Fade the minimap until you enter combat."] = "Die Minikarte ausblenden, bis du in den Kampf gehst."
L["Experimental:"] = "Experimentell:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Das Ausblenden der Minikarte kann gelegentlich dazu führen, dass Verfolgungssymbole erst nach einem /reload wieder aktualisiert werden. Verwendung auf eigene Gefahr."
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "Hat keine Wirkung, während SexyMap die Minikarte steuert (Modus SexyMap oder Hybrid)."
L["Hide in Combat"] = "Im Kampf ausblenden"
L["Hide the minimap while in combat."] = "Die Minikarte im Kampf ausblenden."
L["Show Stance Bar"] = "Haltungsleiste anzeigen"
L["Show Totem Bar"] = "Totemleiste anzeigen"
L["Configure how DragonUI notifies you when friends come online or go offline."] = "Lege fest, wie DragonUI dich benachrichtigt, wenn Freunde online oder offline gehen."
L["Enable BNet Toast"] = "BNet-Benachrichtigung aktivieren"
L["Display Battle.net friend online/offline notifications via toast popup and/or chat messages."] = "Battle.net-Benachrichtigungen zu Online-/Offline-Status von Freunden über Popup und/oder Chatnachrichten anzeigen."
L["Notification Type"] = "Benachrichtigungstyp"
L["Guild Notifications"] = "Gilden-Benachrichtigungen"
L["Show notifications for guild members coming online or going offline. Turn off to only receive friend notifications."] = "Benachrichtigungen anzeigen, wenn Gildenmitglieder online oder offline gehen. Deaktivieren, um nur Freundes-Benachrichtigungen zu erhalten."
L["Show Toast Popup"] = "Popup-Benachrichtigung anzeigen"
L["Display the Battle.net toast frame when a friend comes online or goes offline."] = "Das Battle.net-Benachrichtigungsfenster anzeigen, wenn ein Freund online oder offline geht."
L["Show Chat Notification"] = "Chat-Benachrichtigung anzeigen"
L["Display a chat message when a friend comes online or goes offline."] = "Eine Chatnachricht anzeigen, wenn ein Freund online oder offline geht."
L["Share to:"] = "Teilen mit:"
L["Whisper"] = "Flüstern"
L["Raid"] = "Schlachtzug"
L["Guild"] = "Gilde"
L["Share"] = "Teilen"
L["Enter a target player name for whisper."] = "Gib den Namen eines Zielspielers zum Flüstern ein."
L["Profile shared with"] = "Profil geteilt mit"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Verwendet das Kampfprotokoll, um Zauber von nicht anvisierten Einheiten zu schätzen. Weniger genau als Ziel, Fokus, Mouseover und Arenagegner oben."
L["Sync From Native Cast Bar"] = "Mit nativer Zauberleiste synchronisieren"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "Auf unterstützten Clients die spieleigene Namensplaketten-Zauberleiste für besseres Timing verwenden. Kann bedenkenlos aktiviert bleiben."
L["Native Progress Sync for Off-Target Casts"] = "Native Fortschrittssynchronisierung für Zauber ohne Ziel"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "Falls verfügbar, synchronisieren Kampfprotokoll-Zauberleisten ohne Ziel ihren Fortschritt mit Blizzards nativer Zauberleiste."
L["showVKeyCastbar Mode"] = "showVKeyCastbar-Modus"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: Client-Wert beibehalten. force_on/off: DragonUI setzt showVKeyCastbar, während das Namensplaketten-Modul aktiv ist."
...
L["Transmog Collector"] = "Transmog-Sammler"
L["Enable Transmog Collector"] = "Transmog-Sammler aktivieren"
L["Automatically collect transmog appearances when looting new items. Works with Ascension's Ctrl+Alt+Click appearance system."] = "Sammelt automatisch Transmog-Erscheinungsbilder beim Plündern neuer Gegenstände. Funktioniert mit Ascensions Strg+Alt+Klick-Erscheinungssystem."
L["On loot, auto-collects appearances for items you haven't learned yet."] = "Beim Plündern werden Erscheinungsbilder für noch nicht erlernte Gegenstände automatisch gesammelt."
L["Attack Bar"] = "Angriffsleiste"
L["Shows swing timers for your main hand, off hand, ranged attacks, and enemy target melee swings."] = "Zeigt Schwungtimer für deine Waffenhand, Schildhand, Distanzangriffe und die Nahkampfschwünge des Zielgegners."
L["Enable Attack Bar"] = "Angriffsleiste aktivieren"
L["Show swing timer bars for melee and ranged attacks."] = "Schwungtimer-Leisten für Nah- und Fernkampfangriffe anzeigen."
L["Main Hand Bar"] = "Waffenhand-Leiste"
L["Show the main hand melee swing timer."] = "Den Nahkampf-Schwungtimer der Waffenhand anzeigen."
L["Off Hand Bar"] = "Schildhand-Leiste"
L["Show the off hand melee swing timer (dual-wield)."] = "Den Nahkampf-Schwungtimer der Schildhand anzeigen (beidhändig)."
L["Ranged Bar"] = "Distanzleiste"
L["Show the ranged attack timer (Hunter shots, Throw, Aimed Shot)."] = "Den Distanzangriffstimer anzeigen (Jägerschüsse, Wurf, Gezielter Schuss)."
L["Enemy Bar"] = "Gegnerleiste"
L["Show the enemy target melee swing timer."] = "Den Nahkampf-Schwungtimer des Zielgegners anzeigen."
L["Show Timer"] = "Timer anzeigen"
L["Show the countdown timer text on bars."] = "Den Countdown-Timertext auf den Leisten anzeigen."
L["Show Info"] = "Infos anzeigen"
L["Show spell name, damage range, and time remaining text."] = "Zaubername, Schadensbereich und verbleibende Zeit anzeigen."
L["Choose the border style for the swing timer bars."] = "Wähle den Rahmenstil für die Schwungtimer-Leisten."
L["Standard"] = "Standard"
L["Thin"] = "Dünn"
L["Scale of the swing timer bars."] = "Skalierung der Schwungtimer-Leisten."
L["Swing Timer Module"] = "Schwungtimer-Modul"
L["Shows main hand, off hand, ranged, and enemy target swing timers."] = "Zeigt Schwungtimer für Waffenhand, Schildhand, Distanz und Zielgegner."
...
-- Iconic
L["Iconic"] = "Iconic"
L["Item icons in chat, merchant improvements, and enhanced item tooltips."] = "Gegenstandssymbole im Chat, Händlerverbesserungen und erweiterte Tooltips."

-- Item Loot (Loot Toast)
L["Loot Toast"] = "Beutebenachrichtigungen"
L["Pretty loot toast alert notifications with custom textures."] = "Animierte Beutebenachrichtigungen mit benutzerdefinierten Texturen."

-- About Authors
L["Worked on by MiiKiis for the WoW Hollow server."] = "Überarbeitet von MiiKiis für den WoW Hollow Server."
L["Original work by Neticsoul, with contributions by PentSec and the community."] = "Ursprüngliche Arbeit von Neticsoul, mit Beiträgen von PentSec und der Community."
