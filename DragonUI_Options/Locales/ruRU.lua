...
L["Ignore Keeper's Aura from Target"] = "Игнорировать ауру Keepers у цели"
L["Hide all buffs on the target whose name starts with 'Keeper's'."] = "Скрыть все положительные эффекты цели, название которых начинается с «Keeper's»."
...
L["Recommended Addon"] = "Рекомендуемый аддон"
...
L["Hide Castbar"] = "Скрыть полосу заклинаний"
L["Hide Castbar Desc"] = "Полностью скрывает эту полосу заклинаний: как панель DragonUI, так и стандартную панель Blizzard."
...
L["Use a square minimap with a square border instead of the round DragonUI border."] = "Использовать квадратную миникарту с квадратной рамкой вместо круглой рамки DragonUI."
...
-- Player Stats
L["Player Stats"] = "Статы игрока"
L["Add item level, PvE/PvP power and prestige for player units."] = "Показывает уровень предметов, силу PvE/PvP и престиж для игроков."
...
L["No position presets saved yet. Save one in Edit Mode (/dragonui edit) first."] = "Пресеты позиций ещё не сохранены. Сначала сохраните пресет в режиме редактирования (/dragonui edit)."
L["Position presets not available."] = "Пресеты позиций недоступны."
...
L["Not a valid DragonUI profile string."] = "Не является допустимой строкой профиля DragonUI."
...
L["Anchor Position"] = "Положение якоря"
L["Choose where the combo widget is anchored on the target nameplate health bar."] = "Выберите, где закрепить виджет очков комбо на полосе здоровья индикатора цели."
L["Scale of the combo widget (0.5 - 2.0)."] = "Масштаб виджета очков комбо (0.5 - 2.0)."
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "Горизонтальное смещение от выбранной точки привязки. Отрицательное значение — влево, положительное — вправо."
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "Вертикальное смещение от выбранной точки привязки. Отрицательное значение — вниз, положительное — вверх."
L["Combos Per Row"] = "Комбо в ряду"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "Максимум сегментов комбо в ряду для ресурсов кастомных классов (Reaper, Demonhunter, Ranger, ...). Разбойник и друид используют единую комбинированную иконку и не затрагиваются. При превышении переходит на вторую строку."
...
L["Reset Debuff Position"] = "Сбросить позицию ослабляющих эффектов"
L["Debuff position reset."] = "Позиция ослабляющих эффектов сброшена."
L["Debuffs detached - positioned freely via Editor Mode"] = "Ослабляющие эффекты откреплены — свободно размещаются через режим редактора"
L["Debuffs attached - follow buff row"] = "Ослабляющие эффекты прикреплены — следуют за рядом усиливающих эффектов"
L["Opacity of tabs, buttons and chat background when not hovered. 0 = hidden, 1 = always visible."] = "Непрозрачность вкладок, кнопок и фона чата, когда на них не наведён курсор. 0 = скрыто, 1 = всегда видно."
L["Lock Toggle Hotkey"] = "Горячая клавиша блокировки"
L["Choose the modifier + mouse button used to lock or unlock a bag slot while hovering it."] = "Выберите сочетание модификатора и кнопки мыши для блокировки или разблокировки ячейки сумки при наведении на неё."
L["Use /sortlock to lock or unlock the currently hovered slot from chat."] = "Используйте /sortlock, чтобы заблокировать или разблокировать ячейку под курсором из чата."
...
L["Ctrl + Middle Click"] = "Ctrl + средний клик"
L["Shift + Middle Click"] = "Shift + средний клик"
...
L["Fade the quest tracker until you hover over it."] = "Скрывать трекер заданий, пока вы не наведёте на него курсор."
L["Fade the quest tracker until you enter combat."] = "Скрывать трекер заданий, пока вы не вступите в бой."
L["Hide the quest tracker while in combat."] = "Скрывать трекер заданий в бою."
L["Fade the XP and Reputation bars until you hover over them."] = "Скрывать панели опыта и репутации, пока вы не наведёте на них курсор."
L["Fade the XP and Reputation bars until you enter combat."] = "Скрывать панели опыта и репутации, пока вы не вступите в бой."
L["Hide the XP and Reputation bars while in combat."] = "Скрывать панели опыта и репутации в бою."
L["Fade the player frame until you hover over it."] = "Скрывать рамку игрока, пока вы не наведёте на неё курсор."
L["Fade the player frame until you enter combat."] = "Скрывать рамку игрока, пока вы не вступите в бой."
L["Also fades the Target of Target and target cast bar, attached or not."] = "Также скрывает цель цели и полосу заклинания цели, прикреплённые они или нет."
L["Fade the target frame group until you hover over it."] = "Скрывать группу рамки цели, пока вы не наведёте на неё курсор."
L["Fade the target frame group until you enter combat."] = "Скрывать группу рамки цели, пока вы не вступите в бой."
L["Also fades the Target of Focus and focus cast bar, attached or not."] = "Также скрывает цель фокуса и полосу заклинания фокуса, прикреплённые они или нет."
L["Fade the focus frame group until you hover over it."] = "Скрывать группу рамки фокуса, пока вы не наведёте на неё курсор."
L["Fade the focus frame group until you enter combat."] = "Скрывать группу рамки фокуса, пока вы не вступите в бой."
L["Fade the pet frame until you hover over it."] = "Скрывать рамку питомца, пока вы не наведёте на неё курсор."
L["Fade the pet frame until you enter combat."] = "Скрывать рамку питомца, пока вы не вступите в бой."
L["Fade party frames until you hover over them."] = "Скрывать рамки группы, пока вы не наведёте на них курсор."
L["Fade party frames until you enter combat."] = "Скрывать рамки группы, пока вы не вступите в бой."
L["Fade boss frames until you hover over them."] = "Скрывать рамки боссов, пока вы не наведёте на них курсор."
L["Fade boss frames until you enter combat."] = "Скрывать рамки боссов, пока вы не вступите в бой."
L["Boss"] = "Босс"
L["Fade the stance bar until you hover over it."] = "Скрывать панель стоек, пока вы не наведёте на неё курсор."
L["Fade the stance bar until you enter combat."] = "Скрывать панель стоек, пока вы не вступите в бой."
L["Fade the pet bar until you hover over it."] = "Скрывать панель питомца, пока вы не наведёте на неё курсор."
L["Fade the pet bar until you enter combat."] = "Скрывать панель питомца, пока вы не вступите в бой."
L["Fade the totem bar until you hover over it."] = "Скрывать панель тотемов, пока вы не наведёте на неё курсор."
L["Fade the totem bar until you enter combat."] = "Скрывать панель тотемов, пока вы не вступите в бой."
L["Fade the minimap until you hover over it."] = "Скрывать миникарту, пока вы не наведёте на неё курсор."
L["Fade the minimap until you enter combat."] = "Скрывать миникарту, пока вы не вступите в бой."
L["Experimental:"] = "Экспериментально:"
L["Fading the minimap can occasionally cause tracking icons to stop updating until you /reload. Use at your own risk."] = "Скрытие миникарты иногда может привести к тому, что значки слежения перестанут обновляться до выполнения /reload. Используйте на свой страх и риск."
L["Has no effect while SexyMap controls the minimap (SexyMap or Hybrid mode)."] = "Не действует, пока миникартой управляет SexyMap (режим SexyMap или Гибрид)."
L["Hide in Combat"] = "Скрывать в бою"
L["Hide the minimap while in combat."] = "Скрывать миникарту в бою."
L["Show Stance Bar"] = "Показывать панель стоек"
L["Show Totem Bar"] = "Показывать панель тотемов"
L["Configure how DragonUI notifies you when friends come online or go offline."] = "Настройте, как DragonUI уведомляет вас, когда друзья заходят в сеть или выходят из неё."
L["Enable BNet Toast"] = "Включить уведомления BNet"
L["Display Battle.net friend online/offline notifications via toast popup and/or chat messages."] = "Показывать уведомления Battle.net о входе/выходе друзей во всплывающем окне и/или в сообщениях чата."
L["Notification Type"] = "Тип уведомления"
L["Guild Notifications"] = "Уведомления гильдии"
L["Show notifications for guild members coming online or going offline. Turn off to only receive friend notifications."] = "Показывать уведомления, когда участники гильдии заходят в сеть или выходят из неё. Отключите, чтобы получать только уведомления о друзьях."
L["Show Toast Popup"] = "Показывать всплывающее уведомление"
L["Display the Battle.net toast frame when a friend comes online or goes offline."] = "Показывать всплывающее окно Battle.net, когда друг заходит в сеть или выходит из неё."
L["Show Chat Notification"] = "Показывать уведомление в чате"
L["Display a chat message when a friend comes online or goes offline."] = "Показывать сообщение в чате, когда друг заходит в сеть или выходит из неё."
L["Share to:"] = "Поделиться с:"
L["Whisper"] = "Шёпот"
L["Raid"] = "Рейд"
L["Guild"] = "Гильдия"
L["Share"] = "Поделиться"
L["Enter a target player name for whisper."] = "Введите имя игрока для шёпота."
L["Profile shared with"] = "Профиль отправлен"
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Использует боевой журнал для определения заклинаний целей, которые вы не выбрали. Менее точно, чем цель, фокус, наведение и противники на арене выше."
L["Sync From Native Cast Bar"] = "Синхронизировать с родной полосой заклинания"
L["On supported clients, use the game's built-in nameplate cast bar for better timing. Safe to leave enabled."] = "На поддерживаемых клиентах использовать встроенную полосу заклинания на индикаторе имени для лучшей точности. Можно безопасно оставить включённым."
L["Native Progress Sync for Off-Target Casts"] = "Родная синхронизация прогресса для заклинаний вне цели"
L["When available, off-target combat-log castbars sync their progress from Blizzard's native castbar."] = "При наличии полосы заклинаний из боевого журнала вне цели синхронизируют прогресс с родной полосой заклинания Blizzard."
L["showVKeyCastbar Mode"] = "Режим showVKeyCastbar"
L["auto: keep client value. force_on/off: DragonUI sets showVKeyCastbar while nameplates module is active."] = "auto: сохранять значение клиента. force_on/off: DragonUI устанавливает showVKeyCastbar, пока активен модуль индикаторов имён."
L["Auto (Do Not Force)"] = "Авто (не принудительно)"
L["Force On"] = "Принудительно вкл."
L["Force Off"] = "Принудительно выкл."
L["DragonUI (Custom)"] = "DragonUI (Пользовательский)"
L["Transmog Collector"] = "Сборщик обликов"
L["Enable Transmog Collector"] = "Включить сборщик обликов"
L["Automatically collect transmog appearances when looting new items. Works with Ascension's Ctrl+Alt+Click appearance system."] = "Автоматически собирает облики трансмогрификации при получении новых предметов. Работает с системой обликов Ctrl+Alt+клик от Ascension."
L["On loot, auto-collects appearances for items you haven't learned yet."] = "При получении добычи автоматически собирает облики предметов, которые вы ещё не изучили."
L["Attack Bar"] = "Панель атаки"
L["Shows swing timers for your main hand, off hand, ranged attacks, and enemy target melee swings."] = "Показывает таймеры удара для правой руки, левой руки, дальних атак и ближних ударов цели-противника."
L["Enable Attack Bar"] = "Включить панель атаки"
L["Show swing timer bars for melee and ranged attacks."] = "Показывать полосы таймера удара для ближних и дальних атак."
L["Main Hand Bar"] = "Панель правой руки"
L["Show the main hand melee swing timer."] = "Показывать таймер ближнего удара правой руки."
L["Off Hand Bar"] = "Панель левой руки"
L["Show the off hand melee swing timer (dual-wield)."] = "Показывать таймер ближнего удара левой руки (два оружия)."
L["Ranged Bar"] = "Панель дальнего боя"
L["Show the ranged attack timer (Hunter shots, Throw, Aimed Shot)."] = "Показывать таймер дальней атаки (выстрелы охотника, метание, прицельный выстрел)."
L["Enemy Bar"] = "Панель противника"
L["Show the enemy target melee swing timer."] = "Показывать таймер ближнего удара цели-противника."
L["Show Timer"] = "Показывать таймер"
L["Show the countdown timer text on bars."] = "Показывать текст обратного отсчёта на полосах."
L["Show Info"] = "Показывать сведения"
L["Show spell name, damage range, and time remaining text."] = "Показывать название заклинания, диапазон урона и оставшееся время."
L["Choose the border style for the swing timer bars."] = "Выберите стиль рамки для полос таймера удара."
L["Standard"] = "Стандартный"
L["Thin"] = "Тонкий"
L["Scale of the swing timer bars."] = "Масштаб полос таймера удара."
L["Swing Timer Module"] = "Модуль таймера удара"
L["Shows main hand, off hand, ranged, and enemy target swing timers."] = "Показывает таймеры удара правой руки, левой руки, дальнего боя и цели-противника."
...
-- About Authors
L["Worked on by MiiKiis for the WoW Hollow server."] = "Доработано MiiKiis для сервера WoW Hollow."
L["Original work by Neticsoul, with contributions by PentSec and the community."] = "Оригинальная работа Neticsoul, при участии PentSec и сообщества."
