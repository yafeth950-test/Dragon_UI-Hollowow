...
L["Horizontal offset from the chosen anchor point. Negative moves left, positive moves right."] = "Desplazamiento horizontal desde el punto de anclaje elegido. Los valores negativos mueven a la izquierda y los positivos a la derecha."
L["Vertical offset from the chosen anchor point. Negative moves down, positive moves up."] = "Desplazamiento vertical desde el punto de anclaje elegido. Los valores negativos mueven hacia abajo y los positivos hacia arriba."
L["Combos Per Row"] = "Combos por fila"
L["Maximum combo segments per row on custom-class resources (Reaper, Demonhunter, Ranger, ...). Rogue and Druid use a single combined icon and are not affected. Wrap to a second row when exceeded."] = "Máximo de segmentos de combo por fila en recursos de clases personalizadas (Reaper, Demonhunter, Ranger, ...). Pícaro y Druida usan un solo ícono combinado y no se ven afectados. Al excederlo, pasa a una segunda fila."
...
L["Uses the combat log to guess casts on units you are not targeting. Less accurate than target, focus, mouseover, and arena enemies above."] = "Usa el registro de combate para estimar los conjuros de unidades que no son tu objetivo. Menos preciso que objetivo, foco, cursor y enemigos de arena indicados arriba."
...
L["Keep boss nameplates visible at the top of the screen inside party and raid instances."] = "Mantener visibles las placas de identificación de jefe en la parte superior de la pantalla dentro de mazmorras y bandas."
L["Scales the nameplate clickbox relative to its original size. Recommended to change this setting while out of combat."] = "Escala el área de clic de la placa de identificación en relación con su tamaño original. Se recomienda cambiar este ajuste fuera de combate."
